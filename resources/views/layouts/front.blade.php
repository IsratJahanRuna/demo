...
<head>
  ...
  <link href="{{asset('front/assets/css/jquery.mb.YTPlayer.min.css')}}" media="all" rel="stylesheet" type="text/css">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <script src="{{asset('front/assets/js/bo/otstrap.min.js')}}"></script>
