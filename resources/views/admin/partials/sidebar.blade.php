 <div class="nk-sidebar nk-sidebar-fixed is-light " data-content="sidebarMenu">
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand">
            ...
            <div class="nk-sidebar-brand">
            <a href="#" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" style="max-width:220px; top: 4px; " src="{{asset('assets/imager/logo.frcl.png')}}" srcset="{{asset('public/assets/images/logo.frcl.png 2x')}}" alt="logo">
                            <img class="logo-dark logo-img" style="max-width:220px; top: 4px;" src="{{asset('assets/images/logo.frcl.png')}}" srcset="{{asset('public/assets/images/logo.frcl.png 2x')}}" alt="logo-dark">
                            <img class="logo-small logo-img logo-img-small" style="max-width:220px; top: 4px;" src="{{asset('assets/images/logo.frcl.png')}}" srcset="{{asset('public/assets/images/logo.frcl.png 2x')}}" alt="logo-small">
                        </a>
                    </div>
